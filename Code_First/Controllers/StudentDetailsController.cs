...
namespace Code_First.Controllers
{
    public class StudentDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentId,Address,Phone")] StudentDetails studentDetails)
        {
            ...
            ViewBag.StudentId = new SelectList(db.Students, "StudentId", "Name", studentDetails.StudentId);
            return View(studentDetails);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentId,Address,Phone")] StudentDetails studentDetails)
        {
            if (ModelState.IsValid)
            {
